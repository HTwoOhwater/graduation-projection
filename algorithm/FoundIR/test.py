...
def parsr_args():
    ...
    parser.add_argument("--results_dir", type=str, default='./results', help='folder to save inference outputs')
...
if opt.meta is not None and str(opt.meta).lower() != 'none':
...
if not trainer.accelerator.is_local_main_process:
    ...
    trainer.load(2000)
    trainer.set_results_folder(opt.results_dir)
